...
Description - Hungry Hungry Shark is a first-person VR game experience that simulates the movements of sharks targeting schools of fish. 
              ...
              and the player needs to catch fish to reset that health bar. 
...
Lessons/Achievements - Throughout this project, I faced many obstacles, which were lessons that helped me achieve what I truly wanted to: a VR game that builds off my boid system project. 
                      ...
                      All I had to do was place my boid system into the space, 
                      attach a shark model to the XR Rig, which was the player, 
                      and disable gravity, to allow the shark to essentially float, 
                      or in this case, swim. 
                      I then built an ocean environment due to Unity Asset Store’s lack of ocean and coral assets. 
                      Finally, I made screens to display conditions, like win, loss and start. 
                      The main skills I can take away from this project is getting comfortable to work with and use a VR headset, and I feel that in the future, I can definitely see myself working with them.
...
Audience Feedback - Feedback on my project was surprisingly positive, considering my project was quite simple 
                    ...
                    which was a huge plus, since that is a common flaw of some high paced VR games. 
                    The only complaints on the project were about a bug that I didn’t know how to fix 
                    until someone gave me the simple idea to increase how far the camera can see, which resolved the issue. 
                    Another individual also noted that looking up felt a bit tiring, which I felt was a little annoying as well 
                    until Prof. Lee told me to keep that aspect, since it made the game feel fun.
